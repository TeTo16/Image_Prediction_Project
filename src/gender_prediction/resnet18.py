...
for epoch in range(epochs):
    ...
    train_epoch_loss, train_epoch_accuracy = train_binary(model=resnet18, train_dataloader=train_loader, criterion=criterion, optimizer=optimizer)
    val_epoch_loss, val_epoch_accuracy = validate_binary(model=resnet18, test_dataloader=test_loader, criterion=criterion)
...
labels, predicts = predict_gender(model=resnet18, loader=test_loader, device=device)
